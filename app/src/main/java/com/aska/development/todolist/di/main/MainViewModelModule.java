...
import com.aska.development.todolist.ui.main.tasks.add.TaskAddViewModel;
import com.aska.development.todolist.ui.main.tasks.edit.TaskEditViewModel;
...
public abstract class MainViewModelModule {
    ...
    abstract ViewModel bindTaskAddViewModel(TaskAddViewModel viewModel);

    @Binds
    @IntoMap
    @ViewModelKey(TaskEditViewModel.class)
    abstract ViewModel bindTaskEditViewModel(TaskEditViewModel viewModel);
